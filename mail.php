...
try {
    ...
    $mail->Username = 'kjhilldesigns7@gmail.com';             // SMTP username
    $mail->Password = '4Working!';                           // SMTP password
    $mail->SMTPSecure = 'ssl';                            // Enable SSL encryption, TLS also accepted with port 465
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('kjhilldesigns7@gmail.com', 'Mailer');          //This is the email your form sends From
    $mail->addAddress('kjhilldesigns7@gmail.com', 'Kelly J Hill'); // Add a recipient address
